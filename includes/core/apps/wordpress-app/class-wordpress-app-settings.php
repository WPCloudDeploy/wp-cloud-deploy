	...
	public function site_fields() {
		...
		$fields = array(
			...
			array(
				...
				'type'    => 'number',
				'size'    => 10,
				'name'    => __( 'Quota for sites without a value', 'wpcd' ),
				'desc'    => __( 'Size in MB', 'wpcd' ),
				'tooltip' => __( 'This is the quota that will be used for any site that does not have an individual value applied to it.  If you want all sites to use the same value then set a value here but do NOT set a value on the option below.', 'wpcd' ),
				'tab'     => 'wordpress-app-sites',
			),
			array(
