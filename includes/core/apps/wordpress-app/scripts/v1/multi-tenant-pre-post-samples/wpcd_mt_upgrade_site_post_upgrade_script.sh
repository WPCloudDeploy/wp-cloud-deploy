...
# This is run when an existing multi-tenant site is upgraded (or downgraded to a new version).
#
...
# Note that the mt_convert_site() function is run for new installs as well!
# 
# These include:
...
echo
echo "#######################################################"
echo "After site upgrade custom script running here..."
echo "Nothing to do."
echo "#######################################################"
echo