...
class WPCD_SSH_LOG extends WPCD_POSTS_LOG {
	...
	public function register() {
		register_post_type(
			...
			array(
				'labels'              => array(
					'name'                  => _x( 'SSH Log', 'Post type general name', 'wpcd' ),
					...
					'all_items'             => __( 'All SSH Log Entries', 'wpcd' ),
					'search_items'          => __( 'Search SSH Log', 'wpcd' ),
					'not_found'             => __( 'No SSH Logs were found.', 'wpcd' ),
					'not_found_in_trash'    => __( 'No SSH Logs were found in Trash.', 'wpcd' ),
					'filter_items_list'     => _x( 'Filter SSH Log list', 'Screen reader text for the filter links heading on the post type listing screen. Default "Filter posts list"/"Filter pages list". Added in 4.4', 'wpcd' ),
					'items_list_navigation' => _x( 'SSH Log list navigation', 'Screen reader text for the pagination heading on the post type listing screen. Default "Posts list navigation"/"Pages list navigation". Added in 4.4', 'wpcd' ),
					'items_list'            => _x( 'SSH Log list', 'Screen reader text for the items list heading on the post type listing screen. Default "Posts list"/"Pages list". Added in 4.4', 'wpcd' ),
				),
				'show_ui'             => true,
				'show_in_menu'        => false,
