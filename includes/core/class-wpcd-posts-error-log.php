...
class WPCD_ERROR_LOG extends WPCD_POSTS_LOG {
	...
	public function register() {
		register_post_type(
			...
			array(
				'labels'              => array(
					'name'                  => _x( 'Error Log', 'Post type general name', 'wpcd' ),
					...
					'all_items'             => __( 'All Error Log Entries', 'wpcd' ),
					'search_items'          => __( 'Search Error Log', 'wpcd' ),
					...
					'items_list_navigation' => _x( 'Error Log list navigation', 'Screen reader text for the pagination heading on the post type listing screen. Default "Posts list navigation"/"Pages list navigation". Added in 4.4', 'wpcd' ),
					'items_list'            => _x( 'Error Log list', 'Screen reader text for the items list heading on the post type listing screen. Default "Posts list"/"Pages list". Added in 4.4', 'wpcd' ),
				),
				'show_ui'             => true,
				'show_in_menu'        => false,
