...
/**
 * Class VPN_APP_SETTINGS
 */
class VPN_APP_SETTINGS extends WPCD_APP_SETTINGS {
	...
	public function scripts_fields() {
		...
		$fields = array(
			...
			array(
				'id'   => 'vpn_commands_after_server_install',
				'type' => 'textbox',
	...
	public function promotional_fields() {
		...
		$fields = array(
			array(
				'id'      => 'vpn_promo_item01_url',
				'type'    => 'text',
				'name'    => __( 'URL To First Product Being Promoted', 'wpcd' ),
				'std'     => 'https://spinupvpn.com/help',
			...
			array(
				'id'      => 'vpn_promo_item01_button_option',
				'type'    => 'checkbox',
			...
			array(
				'id'      => 'vpn_promo_item02_button_option',
				'type'    => 'checkbox',
				'name'    => __( 'Make the above promo a button?', 'wpcd' ),
				'tooltip' => __( 'You can make the promo a button or just a standard text link. A button is more obvious but might annoy your users so be careful with this choice.', 'wpcd' ),
				'tab'     => 'vpn-promotions',
